...
void ARPSpoofing::startSpoofingSlot(QString target_ip,QString dev_name){

}

void ARPSpoofing::stopSpoofingSlot(){
...
void ARPSpoofing::init(){
    ...
    /* 移动指针到用户选择的网卡 */
    for (d = alldevs, i = 0; strcmp(d->name,used_network_card.toStdString().c_str()); d = d->next, i++)
        ;
...
void ARPSpoofing::sendSpoofingPackage(QString target){
